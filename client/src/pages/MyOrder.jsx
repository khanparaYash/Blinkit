          ...
          return (
            ...
            >
              <div className="mb-2 text-gray-700 font-semibold flex justify-between">
                <span>Order ID: <span className="text-gray-900">{order.orderId}</span></span>
                <span className="text-sm text-gray-500">Placed {timeAgo(order.createdAt)}</span>
              </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Amount: {DisplayPriceInRupees(order.totalAmt)}</p>
                </div>
              </div>
            </div>
          )
